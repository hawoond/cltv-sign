...
class SignCompleteScreen extends StatefulWidget {
  final String? token;
  const SignCompleteScreen({super.key, this.token});
                ...
                children: [
                  ScaleTransition(
                    ...
                    child: Container(
                      ...
                      child: const Icon(Icons.task_alt, size: 52, color: AppColors.secondary),
                    ),
                  ),
      ...
      child: Column(
        ...
        children: [
          ...
          if (widget.token != null)
            _buildInfoRow('문서 ID', widget.token!.substring(0, 8).toUpperCase()),
        ],
      ),
    );
  }
